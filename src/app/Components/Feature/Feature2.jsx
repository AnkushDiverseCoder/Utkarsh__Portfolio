                            ...
                            <div className="feature-content">
                                <div className="section-title">
                                    <div className="subtitle wow fadeInUp" data-wow-delay=".2s">
                                        My Skills & Expertise <Image src="/assets/images/icon/fireIcon.svg" alt="img" width={16} height={17} />
                                    </div>
                                ...
                                <div className="feature-box style1 child1">
                                    <div className="feature-box-header wow fadeInUp" data-wow-delay=".2s">
                                        <div className="content">
                                            <h5>Video Editing &  Graphics Designs</h5>
                                            <wp className="text">Adobe/Illustrator</wp>
                                        </div>
                                        <div className="icon">
